...
class CategoryTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category_type" do
    assert_difference('CategoryType.count') do
      post category_types_url, params: { category_type: { category_type_name: @category_type.category_type_name } }
    end
  ...
  test "should update category_type" do
    patch category_type_url(@category_type), params: { category_type: { category_type_name: @category_type.category_type_name } }
